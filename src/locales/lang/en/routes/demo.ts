export default {
  ...
  product: {
    ...
    productInfoManagement: 'Product info management',
    productNumberManagement: 'Product number management',
  },
  financialManagement: {
    name: 'Financial management',
    institutionalAccountManagement: 'Account management',
  },
  datasource: {
    name: 'Datasource management',
    basic: 'Basic info',
    mappingConfiguration: 'Mapping configuration',
    distributionRuleConfiguration: 'Distribution rule configuration',
    switchChainConfiguration: 'Switch chain configuration',
    switchRuleConfiguration: 'Switch rule configuration',
