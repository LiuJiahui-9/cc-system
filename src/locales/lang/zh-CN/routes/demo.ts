export default {
  ...
  product: {
    productName: '产品管理',
    productInfoManagement: '产品信息管理',
    productNumberManagement: '产品功能号管理',
  },
  financialManagement: {
    name: '财务管理',
    institutionalAccountManagement: '机构账户管理',
  },
  datasource: {
    name: '数据源管理',
    basic: '基础信息管理',
    mappingConfiguration: '数据源映射配置',
    distributionRuleConfiguration: '分流规则配置',
    switchChainConfiguration: '切换链配置',
    switchRuleConfiguration: '切换规则配置',
    errorCodeMapping: '错误码映射管理',
  },
  table: {
    table: 'Table',
    basic: '基础表格',
